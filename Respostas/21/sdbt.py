...
dss_file_caso_1 = str(pathlib.Path(script_path).joinpath("dss", "SDBT", "v.dss"))
dss_file_caso_2 = str(pathlib.Path(script_path).joinpath("dss", "SDBT", "i.dss"))
dss_file_caso_3 = str(pathlib.Path(script_path).joinpath("dss", "SDBT", "ii.dss"))
dss_file_caso_4 = str(pathlib.Path(script_path).joinpath("dss", "SDBT", "iii.dss"))
...
arquivo_resultados = str(pathlib.Path(script_path).joinpath("dss", "SDBT", "resultados.csv"))

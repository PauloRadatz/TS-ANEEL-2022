...
dss_file_caso_1 = str(pathlib.Path(script_path).joinpath("dss", "ramal", "v.dss"))
dss_file_caso_2 = str(pathlib.Path(script_path).joinpath("dss", "ramal", "i.dss"))
dss_file_caso_3 = str(pathlib.Path(script_path).joinpath("dss", "ramal", "ii.dss"))
dss_file_caso_4 = str(pathlib.Path(script_path).joinpath("dss", "ramal", "iii.dss"))

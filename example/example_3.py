...
dss_file = str(pathlib.Path(script_path).joinpath("../feeders", "line", "1_4c_complete.dss"))
# dss_file = str(pathlib.Path(script_path).joinpath("../feeders", "line", "2_4c_kron.dss"))
# dss_file = str(pathlib.Path(script_path).joinpath("../feeders", "line", "3_4c_components.dss"))
...
dict_to_df["Feeder Energy kWh"] = energy_mwh_power_flow_list
dict_to_df["Load Consumption kWh"] = load_consumption_list
dict_to_df["Losses kWh"] = losses_mwh_list
